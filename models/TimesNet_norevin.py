...
class Model(nn.Module):
    ...
    def __init__(self, configs):
        ...
        if self.task_name == 'long_term_forecast' or self.task_name == 'short_term_forecast' or self.task_name == 'long_term_forecast_no_revin':
    ...
    def forecast(self, x_enc, x_mark_enc, x_dec, x_mark_dec):
        ...
        # embedding
        enc_out = self.enc_embedding(x_enc, None)  # shape [batch_size, seq_len, d_model], d_model is the dimentions of inception block
    ...
    def forward(self, x_enc, x_mark_enc, x_dec, x_mark_dec, mask=None):
        ...
        if self.task_name == 'classification':
            ...
            return dec_out  # [B, N]
        if self.task_name == 'long_term_forecast_no_revin':
